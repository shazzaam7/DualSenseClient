...
public class CRC32DualSense
{
    private static readonly uint[] ChecksumTable =
    {
        ...
        0x916b06e7, 0xe66c3671, 0x7f6567cb, 0x08625775d, 0x9606c2fe, 0xe101f268, 0x7808a3d2, 0x0f0f9344,
    ...
    {
        const uint HASH_SEED = 0xeada2d49;
        uint hashResult = HASH_SEED;

        for (int i = offset; i < offset + length; ++i)
        {
            hashResult = ChecksumTable[(hashResult & 0xFF) ^ data[i]] ^ (hashResult >> 8);
        }
